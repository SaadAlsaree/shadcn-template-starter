...
export const SectionOne: React.FC<SectionOneProps> = ({
  ...
  const formatActions = React.useMemo<TextStyle[]>(
    () => [
      {
        label: t('tiptap.headings.paragraph'),
        element: 'span',
        className: 'grow',
        shortcuts: ['mod', 'alt', '0']
      },
      {
        label: t('tiptap.headings.h1'),
        element: 'h1',
        level: 1,
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <ToolbarButton
          ...
          tooltip={t('tiptap.toolbar.textStyles')}
          aria-label={t('tiptap.toolbar.textStyles')}
