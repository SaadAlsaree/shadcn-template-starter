...
export const teamInfoContent: InfobarContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      description:
        'Configure default roles and permissions in the settings. Roles define what actions team members can perform within the workspace. Common roles include admin, member, and custom roles you define.',
      links: []
    },
    {
    ...
    },
    {
      ...
      description:
        'The application includes a navigation filtering system. It supports role and permission checks for access control. Navigation items are configured in the navigation configuration file.',
      links: []
    }
  ]
};
  ...
  sections: [
    {
      title: 'Overview',
      description:
        "The Billing page allows you to manage your organization's subscription and usage limits. Plans and subscriptions provide organization-level subscription management.",
      links: []
    },
    {
    ...
    },
    {
      ...
      description:
        'Plans and features are used for access control throughout the application. Content is rendered conditionally based on subscription status.',
      links: []
    }
  ]
};
